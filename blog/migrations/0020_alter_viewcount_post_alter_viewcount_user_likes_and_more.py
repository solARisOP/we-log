# Generated by Django 4.2.5 on 2023-10-12 07:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('blog', '0019_remove_viewcount_cookie'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='post',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='viewcount', to='blog.post'),
        ),
        migrations.AlterField(
            model_name='viewcount',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='viewcount', to=settings.AUTH_USER_MODEL),
        ),
